package MPLaboratory.bfs;

import battlecode.common.Direction;
import battlecode.common.MapLocation;
import battlecode.common.RobotController;

public class BFSUnrolled29 {

    static RobotController rc;
    // Includes a ~200 BC cushion
    public static final int MIN_BC_TO_USE = 8000;
    ...
    public static Direction getBestDir(MapLocation target){
        ...
        try {
            ...
            if (rc.onTheMap(l18)) {
                p18 = 1.0 + rc.senseRubble(l18) / 10.0;
                if (v18 > v32 + p18) {
                    v18 = v32 + p18;
                    d18 = d32;
                }
            ...
            if (rc.onTheMap(l20)) {
                p20 = 1.0 + rc.senseRubble(l20) / 10.0;
                if (v20 > v32 + p20) {
                    v20 = v32 + p20;
                    d20 = d32;
                }
            ...
            if (rc.onTheMap(l66)) {
                p66 = 1.0 + rc.senseRubble(l66) / 10.0;
                if (v66 > v80 + p66) {
                    v66 = v80 + p66;
                    d66 = d80;
                }
            ...
            if (rc.onTheMap(l76)) {
                p76 = 1.0 + rc.senseRubble(l76) / 10.0;
                if (v76 > v88 + p76) {
                    v76 = v88 + p76;
                    d76 = d88;
                }
            ...
            if (rc.onTheMap(l92)) {
                p92 = 1.0 + rc.senseRubble(l92) / 10.0;
                if (v92 > v80 + p92) {
                    v92 = v80 + p92;
                    d92 = d80;
                }
            ...
            if (rc.onTheMap(l102)) {
                p102 = 1.0 + rc.senseRubble(l102) / 10.0;
                if (v102 > v88 + p102) {
                    v102 = v88 + p102;
                    d102 = d88;
                }
            ...
            if (rc.onTheMap(l148)) {
                p148 = 1.0 + rc.senseRubble(l148) / 10.0;
                if (v148 > v136 + p148) {
                    v148 = v136 + p148;
                    d148 = d136;
                }
            ...
            if (rc.onTheMap(l150)) {
                p150 = 1.0 + rc.senseRubble(l150) / 10.0;
                if (v150 > v136 + p150) {
                    v150 = v136 + p150;
                    d150 = d136;
                }
            ...
            if (rc.onTheMap(l17)) {
                p17 = 1.0 + rc.senseRubble(l17) / 10.0;
                if (v17 > v31 + p17) {
                    v17 = v31 + p17;
                    d17 = d31;
                }
            ...
            if (rc.onTheMap(l21)) {
                p21 = 1.0 + rc.senseRubble(l21) / 10.0;
                if (v21 > v33 + p21) {
                    v21 = v33 + p21;
                    d21 = d33;
                }
            ...
            if (rc.onTheMap(l53)) {
                p53 = 1.0 + rc.senseRubble(l53) / 10.0;
                if (v53 > v67 + p53) {
                    v53 = v67 + p53;
                    d53 = d67;
                }
            ...
            if (rc.onTheMap(l63)) {
                p63 = 1.0 + rc.senseRubble(l63) / 10.0;
                if (v63 > v75 + p63) {
                    v63 = v75 + p63;
                    d63 = d75;
                }
            ...
            if (rc.onTheMap(l105)) {
                p105 = 1.0 + rc.senseRubble(l105) / 10.0;
                if (v105 > v93 + p105) {
                    v105 = v93 + p105;
                    d105 = d93;
                }
            ...
            if (rc.onTheMap(l115)) {
                p115 = 1.0 + rc.senseRubble(l115) / 10.0;
                if (v115 > v101 + p115) {
                    v115 = v101 + p115;
                    d115 = d101;
                }
            ...
            if (rc.onTheMap(l147)) {
                p147 = 1.0 + rc.senseRubble(l147) / 10.0;
                if (v147 > v135 + p147) {
                    v147 = v135 + p147;
                    d147 = d135;
                }
            ...
            if (rc.onTheMap(l151)) {
                p151 = 1.0 + rc.senseRubble(l151) / 10.0;
                if (v151 > v137 + p151) {
                    v151 = v137 + p151;
                    d151 = d137;
                }
